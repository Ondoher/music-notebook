...
- [Architecture Index](/c:/dev/music-notebook/agents/topics/architecture/README.md)
- [Foundation Architecture](/c:/dev/music-notebook/agents/topics/architecture/foundation-architecture.md)
...
- [Testing Index](/c:/dev/music-notebook/agents/topics/testing/README.md)
- [Testing Strategy](/c:/dev/music-notebook/agents/topics/testing/testing-strategy.md)
...
- [POC Index](/c:/dev/music-notebook/agents/topics/poc/README.md)
- [Initial POC](/c:/dev/music-notebook/agents/topics/poc/initial-poc.md)
  - spike goal
...
- [poly-gc-react architecture notes](/c:/dev/poly-gc-react/agents/topics/architecture/README.md)
  - strongest reference for topic-style architecture synthesis
- [polylith](/c:/dev/polylith)
